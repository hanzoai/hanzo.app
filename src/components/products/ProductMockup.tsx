  ...
  <div className="bg-neutral-950 rounded-xl border border-neutral-800 overflow-hidden">
    ...
    <div className="p-4 border-b border-neutral-800">
      <div className="flex items-center gap-3">
        ...
        <button className="px-4 py-2 bg-white text-neutral-900 text-sm rounded-lg hover:bg-white/90">
          Search
        </button>
      </div>
    </div>
  ...
  <div className="bg-neutral-950 rounded-xl border border-neutral-800 overflow-hidden">
    ...
    <div className="p-4 border-b border-neutral-800">
      ...
      <div className="h-2 bg-neutral-800 rounded-full overflow-hidden">
        <motion.div
          className="h-full bg-gradient-to-r from-white to-orange-500"
          initial={{ width: 0 }}
          animate={{ width: '30%' }}
  ...
  <div className="bg-neutral-950 rounded-xl border border-neutral-800 overflow-hidden">
    ...
    <div className="flex items-center gap-2 px-4 py-3 border-b border-neutral-800 bg-neutral-900/50">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <span className="text-xs text-neutral-400">gpt-5</span>
      </div>
    </div>
    ...
    <div className="p-4 border-t border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        />
        <button className="p-2 bg-white text-neutral-900 rounded-lg hover:bg-white/90">
  ...
  <div className="bg-neutral-950 rounded-xl border border-neutral-800 overflow-hidden">
    ...
    <div className="p-6 relative">
      <div className="flex items-center justify-between">
        ...
        {/* Arrow */}
        <motion.div
          className="flex-1 h-0.5 bg-gradient-to-r from-white to-cyan-400 mx-2"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
  ...
  <div className="bg-neutral-950 rounded-xl border border-neutral-800 overflow-hidden">
    ...
    <div className="p-8 flex items-center justify-center">
      <div className="text-center">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-white/20 to-purple-500/20 border border-white/30 flex items-center justify-center mx-auto mb-4">
          <motion.div
