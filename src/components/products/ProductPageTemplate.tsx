  ...
  return (
    ...
    >
      <Link to={product.href}>
        <Card className="bg-neutral-900/50 border-neutral-800 hover:border-white/50 transition-all duration-300 h-full group cursor-pointer hover:bg-neutral-900/80">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {product.docs && (
                    <Button
                      size="lg"
                      className="bg-white text-neutral-900 hover:bg-white/90 border-0"
                      asChild
                    >
            ...
            >
              ...
              <Tabs defaultValue={installMethods[0]} className="w-full">
                <TabsList className={`grid w-full grid-cols-${Math.min(installMethods.length, 4)} bg-neutral-900/50 border border-neutral-800 p-1 rounded-xl`}>
                  {product.install.cli && (
                    <TabsTrigger value="cli" className="data-[state=active]:bg-white data-[state=active]:text-neutral-900 rounded-lg">
                      <Terminal className="h-4 w-4 mr-2" />
                      CLI
                    </TabsTrigger>
                  )}
                  {product.install.docker && (
                    <TabsTrigger value="docker" className="data-[state=active]:bg-white data-[state=active]:text-neutral-900 rounded-lg">
                      Docker
                    </TabsTrigger>
                  )}
                  {product.install.npm && (
                    <TabsTrigger value="npm" className="data-[state=active]:bg-white data-[state=active]:text-neutral-900 rounded-lg">
                      npm
                    </TabsTrigger>
                  )}
                  {product.install.pip && (
                    <TabsTrigger value="pip" className="data-[state=active]:bg-white data-[state=active]:text-neutral-900 rounded-lg">
                      pip
                    </TabsTrigger>
                  )}
                </TabsList>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <a
                ...
                className="group"
              >
                <Card className="bg-neutral-900/50 border-neutral-800 hover:border-white/50 transition-all duration-300 h-full">
                  <CardHeader>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-neutral-900 hover:bg-white/90 border-0 text-lg px-8"
                asChild
              >
                <Link to="/pricing">
                  Start Free
