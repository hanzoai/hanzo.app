...
const modelCategories = [
  ...
  },
  {
    ...
    models: [
      { name: "GPT-5", provider: "Open Source", features: ["Multimodal capabilities", "Advanced reasoning", "High accuracy", "Fast performance"] },
      { name: "Claude Opus", provider: "Open Source", features: ["Best reasoning", "Strong knowledge retrieval", "Long context window", "Low hallucination rate"] },
      { name: "Llama 4 Maverick", provider: "Open Source", features: ["Strong multilingual support", "Open weights", "Fast inference", "Cost-effective"] },
      { name: "Gemini 2.5 Pro", provider: "Open Source", features: ["Multimodal reasoning", "Good tool use", "State-of-the-art performance", "Works in many languages"] },
